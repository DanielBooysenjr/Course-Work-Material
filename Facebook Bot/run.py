...
class Facebook_Bot:
    ...
    def Post(self):       
        ...
        try:
            ...
            print('Pasted text successfully, clicking on post button now...')
        except Exception as e:
        ...
        try:
            # Post to group
            time.sleep(10)
            post = self.driver.find_element(By.XPATH, gvars.postnow).click()
            time.sleep(10)
        except Exception as e:
...
class main_gui:
    def __init__(self):
        ...
        self.dropdown_button = customtkinter.CTkOptionMenu(self.app,width=150, corner_radius=6, height=30,
                                                    values=['Choose Product...','Cleaning', 'Lighters', 'Blankets', 'Bracelets', 'Babygrows'], command=lambda value: dropdown(self, value))
